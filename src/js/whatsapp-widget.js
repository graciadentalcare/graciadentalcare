let paramsDefault = {
    ...
    optionsChat: {
        buttonTarget: `https://api.whatsapp.com/send?phone=+6287741335373&text=${encodeURIComponent("Hello Gracia Dental Care, Nama Saya...")}`,
        text: 'Open chat'
    },
    optionsBot: {
        name: 'Gracia Dental Care',
        image: 'https://ik.imagekit.io/oqvzaydqsy/29090135_571417146566258_5538976655998976000_n_-N_vmUSBD.jpg?ik-sdk-version=javascript-1.4.3&updatedAt=1665315916599',
        messageDefault: 'Hi, 👋 saya Gracia Dental Care, ada bisa yang di bantu?',
